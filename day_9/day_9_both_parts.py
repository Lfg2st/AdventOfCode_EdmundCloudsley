...
# taken from: https://github.com/danagle/advent-of-code-python/blob/main/2024/09/solution.py; this solution was not produced by me
...
if __name__ == "__main__":
    parsed_input = parse_input("day_9/input.txt")
